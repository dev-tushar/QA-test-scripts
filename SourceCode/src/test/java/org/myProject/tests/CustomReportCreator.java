...
import org.myProject.utils.DataPropertFileUtil;
...
public class CustomReportCreator implements IReporter {
  ...
  public void generateReport(List<XmlSuite> xml, List<ISuite> suites, String outdir) {
    ...
    if (tier.equalsIgnoreCase("prod")) {
      ...
      tier = "Staging";
      appurl = "http://myprojectqa.standards.ieee.org/myproject-web/rest/signin";
    } 
  ...
  public void generateSuiteSummaryReport(List<ISuite> suites) {
    ...
    for (ISuite suite : suites) {
      ...
      for (ISuiteResult r : tests.values()) {
        ...
        qty_tests_suite += q;
        total_tests += q;
        m_out.print("<td style=\"background-color:#E5F4E5\">" + q + "</td>");
    ...
    if (qty_tests > 1) {
      ...
      m_out.print("<td style=\"background-color:#E5F4E5\">" + qty_pass_m + "</td>");
  ...
  protected void startHtml(PrintWriter out, String tier, String appurl) {
    ...
    out.println("<head>");
    out.println("<title>IEEE | MyProject - TestNG Report</title>");
    ...
    out.println(".passedodd td {background-color: #E5F4E5}");
    out.println(".passedeven td {background-color: #3F3}");
    out.println(".skippedodd td {background-color: #CCC}");
    out.println(".skippedodd td {background-color: #DDD}");
    out.println(".failedodd td,.numi_attn {background-color: #F0D7D7}");
    out.println(".failedeven td,.stripe .numi_attn {background-color: #F0D7D7}");
    out.println(".stacktrace {white-space:pre;font-family:monospace}");
    out.println(".totop {font-size:85%;text-align:center;border-bottom:2px solid #000}");
    out.println("</style>");
    out.println("</head>");
    out.println("<body>");
    out.println("<h1><center>IEEE | MyProject - Automation Report On " + "<a target=\"_blank\" href=\"" + appurl + "\">" + tier + "</a>"
